...
#===============================================
# Importing deque from collections module to implement a queue for BFS
...
def bfs(start_state, goal_state):
    """Performs BFS to find the solution path from the start state to the goal state."""
    # Initialize the start node
    start_node = Node(start_state, None, None, 0)

    # Queue (FIFO) to keep track of nodes to be explored
    ...
    while frontier:
        # Dequeue the front node (the current node to explore)
...
def main():
    ...
    # Run BFS and get the result (solution path)
